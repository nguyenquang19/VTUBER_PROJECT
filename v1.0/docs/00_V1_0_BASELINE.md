...
>
> **Current product version:** `1.4.1` — khóa bootstrap entrypoint cũ để production chỉ chạy qua
> `scripts/start_live.ps1` và `StreamRuntime`. `1.4.0` thêm grounded character-lore material có
...
| `orchestrator/main.py` | compatibility shim fail-fast; không phải runtime production |
