...
class DirectorLoop:
    def __init__(
        ...
        self._speech_style_formula_observed_delivery_total = 0
        self._speech_style_formula_observed_hit_total = 0
    ...
    async def _maybe_speak(
        ...
        *,
        ...
        if spoken:
            ...
            observed_phrases = self._speech_style.record(delivered_text)
            if observed_phrases:
                self._speech_style_formula_observed_delivery_total += 1
                self._speech_style_formula_observed_hit_total += len(observed_phrases)
        return spoken
        ...
        return {
            ...
            **self._director.get_metrics(),
            ...
            "director_speech_style_formula_observed_delivery_total": (
                self._speech_style_formula_observed_delivery_total
            ),
            "director_speech_style_formula_observed_hit_total": (
                self._speech_style_formula_observed_hit_total
            ),
