...
class EventLedger(EventLedgerService):
    ...
    def from_loader(
        ...
        *,
        ...
        return cls(
            max_events=int(loader.get("state", "agent_state.recent_events_max")),
            event_ttl_s=float(loader.get("state", "agent_state.recent_event_ttl_s")),
            dedup_ttl_s=float(loader.get("state", "agent_state.dedup_ttl_s")),
            clock=clock,
            metrics=metrics,
        )
