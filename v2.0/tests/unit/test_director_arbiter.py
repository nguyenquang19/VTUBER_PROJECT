...
def test_delivered_continue_thread_keeps_boundary_over_new_chat() -> None:
    now = datetime.fromtimestamp(1.0, tz=timezone.utc)
    thread = OpenThread(
